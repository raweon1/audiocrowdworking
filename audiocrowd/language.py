...
labels = {
    "en": {
        ...
        "qualification_job_questions": ["General Questions",
                                        ...
                                        "What type of listening device do you use for this task? Please use headphones "
                                        "if possible.",
                                        "Continue"],
        "qualification_job_questionnaire_meta": ["Questions",
                                                 ...
                                                 "almost always",
                                                 "Submit"],
        "qualification_job_questionnaire": [
            "When you are watching a film in a cinema or a play in a theatre, are you able to understand what is being said (either on the screen or on stage) if people around you are rustling paper or whispering?",
        ...
        "acr_job_setup": ["Setup - Evaluation of speech quality",
                          ...
                          "Please perform this task in a quiet environment.",
                          "Please asses the background noise of your surrounding environment.",
                          "Continue", ],
        "acr_job_end": ["VCODE",
    ...
    "de": {
        ...
        "qualification_job_questions": ["Demografische Daten",
                                        ...
                                        "Ich denke,...",
                                        "Bitte beschreiben Sie die Hintergrundlautstärke in Ihrer Umgebung.",
